# ARMS Renewal Installation Manual - CUPE Jobs UI Server

These instructions are specific to installing ARMS UI (cupejobs[uat/qa/prod]-web-n) with a docker using a Virtual Machine provided by UIT SMS.
...
OS: Latest version of Ubuntu (currently 22.04)
